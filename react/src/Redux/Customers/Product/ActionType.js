...
export const FIND_PRODUCT_BY_OCCASION_REQUEST = 'FIND_PRODUCT_BY_OCCASION_REQUEST';
export const FIND_PRODUCT_BY_OCCASION_SUCCESS = 'FIND_PRODUCT_BY_OCCASION_SUCCESS';
export const FIND_PRODUCT_BY_OCCASION_FAILURE = 'FIND_PRODUCT_BY_OCCASION_FAILURE';
