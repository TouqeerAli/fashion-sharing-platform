...
const initialState = {
  ...
  error: null,
  deleteProduct: null,
  // New state for occasion-specific products
  occasionProducts: {},
  occasionLoading: {},
  occasionError: {}
};
...
const customerProductReducer = (state = initialState, action) => {
  switch (action.type) {
    ...
    // Modified occasion-related cases
    case FIND_PRODUCT_BY_OCCASION_REQUEST:
      return {
        ...state,
        occasionLoading: {
          ...state.occasionLoading,
          [action.payload]: true
        },
        occasionError: {
          ...state.occasionError,
    ...
    case FIND_PRODUCT_BY_OCCASION_SUCCESS:
      return {
        ...state,
        occasionProducts: {
          ...state.occasionProducts,
          [action.payload.occasion]: action.payload.products
        },
        occasionLoading: {
          ...state.occasionLoading,
          [action.payload.occasion]: false
        },
        occasionError: {
          ...state.occasionError,
          [action.payload.occasion]: null
        }
      };
    case FIND_PRODUCT_BY_OCCASION_FAILURE:
      return {
        ...state,
        occasionLoading: {
          ...state.occasionLoading,
        ...
        occasionError: {
          ...state.occasionError,
          [action.payload.occasion]: action.payload.error
        }
      };
